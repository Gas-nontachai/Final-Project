...
if (isset($_POST['fetch_booking_details'])) {
    ...
    $sql = "SELECT BK.booking_id, BK.book_lock_number, ZD.zone_name, ZD.zone_detail, C.cat_name, SC.sub_cat_name, BK.booking_type, BK.booking_amount, BK.slip_img, BS.status, BK.booking_date ,BK.total_price
            FROM booking AS BK 
